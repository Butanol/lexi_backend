...
def add_suspicion_scores(
    ...
    model_path: str = "Part 1 - AML monitoring/langchain-workflow/model/xgb_suspicion_model1.pkl",
    encoders_path: str = "Part 1 - AML monitoring/langchain-workflow/model/label_encoders1.pkl",
    threshold: float = 0.7
):
    """
...
df_with_preds = add_suspicion_scores(
    input_csv="Part 1 - AML monitoring/langchain-workflow/langchain_modules/data/transactions_mock_1000_for_participants.csv",
    output_csv="Part 1 - AML monitoring/langchain-workflow/langchain_modules/data/test1.csv"
)